 ...
 * @author ADMIN
 */
public class EditTaiKhoanGUI extends javax.swing.JFrame {

    /**
     * Creates new form EditTaiKhoanGUI
     */
    public EditTaiKhoanGUI() {
        initComponents();
    }
...
//            TaiKhoanDAO.getInstance().addAccount(fullName, user, password, role, email,1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditTaiKhoanGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditTaiKhoanGUI().setVisible(true);
            }
        });
    }
